      ...
      <section className='px-7 mt-5'>
          <div className="flex min-h-[75vh] items-center justify-center">
            <div className="w-full max-w-[420px] rounded-md border border-gray-200 p-5">
              <div className="text-center text-sm font-medium pt-5 mb-4"> Register a new account </div>
              <div className="w-full mb-3 block">
                <label htmlFor="label-username" className="w-full mb-2 block text-xs font-medium"> Username </label>
                <input type="text" name="username" id="label-username" className="w-full border border-gray-200 min-h-[45px] max-h-[45px] rounded-sm outline-0 ring-0 duration-500 focus-within:ring-2 ring-gray-300 text-xs px-4" />
              </div>
              <div className="w-full mb-3 block">
