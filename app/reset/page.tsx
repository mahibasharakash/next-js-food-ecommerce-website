      ...
      <section className='px-7 mt-5'>
          <div className="flex min-h-[75vh] items-center justify-center">
            <div className="w-full max-w-[420px] rounded-md border border-gray-200 p-5">
              <div className="text-center text-lg font-medium pt-5"> Get your password </div>
              <div className="text-center text-xs font-medium mb-5"> Please provide reset code and new password. </div>
              ...
              <div className="w-full mb-3 block">
                <label htmlFor="label-reset-code" className="w-full mb-2 block text-xs font-medium"> Reset Code </label>
                <input type="text" name="reset-code" id="label-reset-code" className="w-full border border-gray-200 min-h-[45px] max-h-[45px] rounded-sm outline-0 ring-0 duration-500 focus-within:ring-2 ring-gray-300 text-xs px-4" />
              </div>
              <div className="w-full mb-3 block">
              ...
              <div className="w-full mb-3 block">
                <label htmlFor="label-repead-password" className="w-full mb-2 block text-xs font-medium"> Repead Password </label>
                <div className="w-full relative">
                  <input type="password" name="repead-password" id="label-repead-password" className="w-full border border-gray-200 min-h-[45px] max-h-[45px] rounded-sm outline-0 ring-0 duration-500 focus-within:ring-2 ring-gray-300 text-xs px-4" />
                  <div className="absolute top-0 bottom-0 end-0 pe-4 flex items-center">
                    <button type="button" className="p-0 m-0 cursor-pointer">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="min-w-[20px] min-h-[20px] max-w-[20px] max-h-[20px]">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
