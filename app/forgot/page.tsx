          ...
          <div className="flex min-h-[75vh] items-center justify-center">
            <div className="w-full max-w-[420px] rounded-md border border-gray-200 p-5">
              ...
              <div className="w-full block mb-5">
                <button type="button" className="w-full flex justify-center items-center min-h-[45px] max-h-[45px] rounded-sm cursor-pointer bg-gray-200 text-xs font-medium"> Reset Account </button>
              </div>
